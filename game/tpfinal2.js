...
class Assets {
  ...
  cargarImagenes() {
    this.imagenes.fondo = loadImage('assets/fondo.png', 
      () => this.verificarCarga(),
      () => { this.imagenes.fondo = null; this.verificarCarga(); }
    );
    this.imagenes.jugador = loadImage('assets/pandoraplayer.png', 
      () => this.verificarCarga(),
      () => { this.imagenes.jugador = null; this.verificarCarga(); }
    );
    this.imagenes.bueno = loadImage('assets/cosobueno.png', 
      () => this.verificarCarga(),
      () => { this.imagenes.bueno = null; this.verificarCarga(); }
    );
    this.imagenes.malo = loadImage('assets/cosomalo.png', 
      () => this.verificarCarga(),
      () => { this.imagenes.malo = null; this.verificarCarga(); }
    );
    
    setTimeout(() => {
      if (!this.cargaCompleta) {
        console.log("Timeout: Continuando sin imágenes");
